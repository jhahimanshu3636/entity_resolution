...
name\_sim = 0.50 \* token\_jaccard
\+ 0.30 \* sequence\_ratio\_with\_prefix\_bonus
\+ 0.20 \* token\_coverage
...
context\_sim = 0.30 \* route\_score
\+ 0.40 \* product\_score
\+ 0.30 \* volume\_score
...
composite = name\_weight \* name\_sim + context\_weight \* context\_sim
